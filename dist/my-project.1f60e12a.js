...
})({"1Bhkq":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "457ef8821f60e12a";
"use strict";
...
function renderCountryList(countries) {
    const markup = countries.map((c)=>`<li>
...
},{"./fetchCountries":"bCGdT","lodash.debounce":"irvaP","@pnotify/core":"fay4s","@pnotify/core/dist/PNotify.css":"c4y47","@pnotify/core/dist/BrightTheme.css":"grIyt","@parcel/transformer-js/src/esmodule-helpers.js":"es00R"}],"bCGdT":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>fetchCountries);
function fetchCountries(name) {
    const fields = 'name,capital,population,languages,flags';
    return fetch(`https://restcountries.com/v2/name/${name}?fields=${fields}`).then((response)=>{
        if (!response.ok) throw new Error(response.status);
        return response.json();
    });
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"es00R"}],"es00R":[function(require,module,exports,__globalThis) {
...
},{}],"c4y47":[function() {},{}],"grIyt":[function() {},{}]},["1Bhkq","fILKw"], "fILKw", "parcelRequire716c", {})

//# sourceMappingURL=my-project.1f60e12a.js.map
